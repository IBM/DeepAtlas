...
class NSGA2Recommender(object):
    @staticmethod
    def run(exp, pop_size=20, n_gen=50):
        ...
        res = minimize(MPProblem(exp, movable_mask), algorithm, ('n_gen', n_gen), seed=2023, verbose=True)
...
class MPProblem(ElementwiseProblem):
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        ...
        out["F"] = [cost, availability, performance]
