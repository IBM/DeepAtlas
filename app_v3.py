...
app.title = "API-aware Hybrid Cloud Migration for Interactive Microservices"

server = app.server
app.config.suppress_callback_exceptions = True
exp.config_onprem.LIMIT_CPU_CORE = 4
exp.config_onprem.LIMIT_MEMORY_GB = 8
exp.config_onprem.LIMIT_DISK_GB = 16
