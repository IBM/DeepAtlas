...
class MPProblem(ElementwiseProblem):
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        ...
        out["F"] = [cost, performance, availability]
...
res = minimize(MPProblem(exp), algorithm, ('n_gen', 100), seed=1, verbose=True)
labels = ['Cost (USD)', '# of Intercloud Links', 'Data Migration (%)']
