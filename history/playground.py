...
cloud_components = {'post-storage-service'}
...
if __name__ == '__main__':
    ...
    print('Old Performance (GT) : %.2f ms' % (groundtruth * 1e-3))
    print('Old Performance (Est): %.2f ms' % (estimation * 1e-3))
    ...
    print('New Performance (Est): %.2f ms' % (get_duration(_trace[0], _traceMap) * 1e-3))
