...
LOW_DAYS = 3
HIGH_DAYS = 7
GLOBAL_EXPERIMENT_DURATION = 60 * 10 * (LOW_DAYS + HIGH_DAYS)    # None = Run forever, 43200 = 12 hour
GLOBAL_SECONDS_PER_DAY     = 60 * 10    # 3600 = 1 hour
GLOBAL_MIN_USERS_I         = 50
GLOBAL_MIN_USERS_II        = 100
GLOBAL_PEAKS_I             = [180, 200, 220]
GLOBAL_PEAKS_II            = [360, 400, 440]
...
users_dummy_free = list(range(500000, 600000))
users_dummy_used = []
friendship = set()
...
class SocialNetworkUser(HttpUser):
    ...
    compositions2 = {login: 8, register: 8, follow: 8, unfollow: 2,
                     readHomeTimeline: 50, readUserTimeline: 10, composePost: 115}  # TODO: Try 2x first, then if OK, 3x