...
########################################################################################################################
GLOBAL_NGINX_FRONTEND_URL  = 'http://c4130-110233.wisc.cloudlab.us:32133/frontend'
GLOBAL_MEDIA_FRONTEND_URL  = 'http://c4130-110233.wisc.cloudlab.us:32133/media'

GLOBAL_EXPERIMENT_DURATION = 60 * 10 * 13    # None = Run forever, 43200 = 12 hour
GLOBAL_SECONDS_PER_DAY     = 60 * 10    # 3600 = 1 hour
GLOBAL_MIN_USERS           = 50
GLOBAL_PEAKS               = [150, 160, 170, 180, 190, 200]
...
class SocialNetworkUser(HttpUser):
    ...
    compositions = [
        {login: 10, register: 10, follow: 10, unfollow: 10, readHomeTimeline: 10, readUserTimeline: 10, composePost: 10},

        {login: 40, register: 15, follow: 12, unfollow: 8, readHomeTimeline: 10, readUserTimeline: 5, composePost: 10},
        {login: 8, register: 40, follow: 10, unfollow: 10, readHomeTimeline: 15, readUserTimeline: 12, composePost: 5},
        {login: 15, register: 12, follow: 40, unfollow: 5, readHomeTimeline: 8, readUserTimeline: 10, composePost: 10},
        {login: 10, register: 15, follow: 10, unfollow: 40, readHomeTimeline: 12, readUserTimeline: 8, composePost: 5},
        {login: 12, register: 8, follow: 5, unfollow: 15, readHomeTimeline: 40, readUserTimeline: 10, composePost: 10},
        {login: 15, register: 12, follow: 10, unfollow: 8, readHomeTimeline: 10, readUserTimeline: 40, composePost: 5},

        {login: 5, register: 10, follow: 8, unfollow: 12, readHomeTimeline: 15, readUserTimeline: 40, composePost: 10},
        {login: 12, register: 15, follow: 10, unfollow: 10, readHomeTimeline: 40, readUserTimeline: 8, composePost: 5},
        {login: 10, register: 8, follow: 5, unfollow: 40, readHomeTimeline: 12, readUserTimeline: 15, composePost: 10},
        {login: 8, register: 12, follow: 40, unfollow: 10, readHomeTimeline: 15, readUserTimeline: 10, composePost: 5},
        {login: 10, register: 40, follow: 15, unfollow: 5, readHomeTimeline: 8, readUserTimeline: 12, composePost: 10},
        {login: 40, register: 10, follow: 8, unfollow: 10, readHomeTimeline: 12, readUserTimeline: 15, composePost: 5},
    ]
